        ...
        <div class="col-lg-12">
            <div class="ibox">
                <div class="ibox-content">
                    <form method="post" class="checkColorForm theForm" id="editForm" data-index="{{route('admin_cms_banner_index')}}">
                        ...
                        <div class="form-group  row uploadImageBox"><label class="col-sm-2 col-form-label">缩略图</label>
                            <div class="col-sm-10">
                                <div class="logoFormBtn uploadBtn text-center">
                                    @if($data->image_url)
                                        <img src="{{$data->image_url}}" width="160" height="160" />
                                        @else
                        ...
                        <div class="form-group row urlBox"><label class="col-sm-2 col-form-label">图片网址</label>
                            <div class="col-sm-10"><input type="text" class="form-control" name="param[image_url]" autocomplete="false" placeholder="" value="{{$data->image_url}}" required></div>
                        </div>
                        <div class="form-group row"><label class="col-sm-2 col-form-label">图片超链接</label>
                            <div class="col-sm-10"><input type="text" class="form-control" name="param[link]" autocomplete="false" placeholder="" value="{{$data->link}}"></div>
                        </div>
                        <div class="form-group  row"><label class="col-sm-2 col-form-label">排序值</label>
                            <div class="col-sm-10"><input type="text" class="form-control" name="param[sort_id]" placeholder="" value="{{$data->sort_id}}">
                                <p>值越大越靠前</p>
                            </div>
                        </div>
                        <div class="form-group  row"><label class="col-sm-2 col-form-label">图片状态</label>
                            <div class="col-sm-10">
                                <select class="form-control">
                                    ...
                                    <option value="0" {!! $data->status == 0 ? 'selected' : '' !!}>不显示</option>
                                </select>
                            </div>
                        </div>
